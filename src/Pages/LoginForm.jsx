...
import { auth } from '../../firebase'; // Import your firebase config
import { addUserSession } from '../Components/MyAccount/sessionManager'; // Import session manager
...
const LoginForm = () => {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      // Add session tracking for Google sign-in
      const sessionData = createSessionData();
      await addUserSession(result.user.uid, sessionData);
