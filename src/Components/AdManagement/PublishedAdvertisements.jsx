// PublishedAdvertisements.jsx
import React, { useState } from 'react';
import { ChevronDown } from 'lucide-react';

const PublishedAdvertisements = () => {
  ...
  return (
    <div className="w-full max-w-4xl p-4 font-poppins  rounded  bg-white ml-4 mt-5">
      <h2 className="text-[25px] font-[500] mb-1 text-black">Published Advertisements</h2>
      ...
      <div className="flex justify-between items-center border border-[#1544AB] placeholder-[#8D8D8D] font-[400] text-[18px] rounded-md px-4 py-2">
        <div className="text-[#231E1C] font-[400] text-[18px]">No Ads Found</div>
...
export default PublishedAdvertisements;