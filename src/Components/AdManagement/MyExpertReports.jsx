  ...
  return (
    <div className="bg-white border border-[#1544AB] rounded-md shadow-lg p-3 w-64">
      <div className="flex justify-between items-center mb-3">
        <button onClick={prevMonth} className="text-[#1544AB]">
          ←
        </button>
        <div className="font-medium">
          {monthNames[month]} {year}
        </div>
        <button onClick={nextMonth} className="text-[#1544AB]">
          →
        </button>
      </div>
  ...
  return (
    <div className="w-full border border-[#1544AB] rounded-lg p-6 bg-white mt-1 absolute z-20 shadow-lg">
      <div className="flex justify-between items-center mb-2">
        ...
        <button onClick={onClose} className="text-[#1544AB]">
          <FaCaretUp className="h-8 w-8" />
        </button>
      </div>

      <p className="text-[#8D8D8D] mb-6 font-[400]">
           You can find your reports quickly with detailed search.
      </p>
        ...
        <div className="mb-6">
          ...
          <div className="flex flex-wrap gap-6">
            <label className="inline-flex items-center">
              ...
              />
              <span className="ml-2 text-base font-[400]">Added to the Advertisement</span>
            </label>
            ...
            <label className="inline-flex items-center">
              ...
              />
              <span className="ml-2 text-base font-[400]">
              Not Added To Advertisment
              </span>
            </label>
...
export default MyExpertReports;
