...
export const AutoExpertiseForm = () => {
    ...
    <div className="max-w-7xl w-full mx-auto p-4 font-poppins bg-white rounded">
      <div className="max-w-5xl  ">
        ...
        <p className="mt-2 font-[400] text-[20px] leading-7 text-black">
          ...
          branches of sahibinden.com's professional business partner Auto King
          Auto Expertise and get comprehensive expertise packages at affordable
          prices.
        </p>
