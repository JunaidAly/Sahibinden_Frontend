...
const CommentForm = () => {
  return (
    <>
      ...
      <h2 className="text-[28px] font-poppins leading-[100%] font-bold my-10 text-[#434343]">
        Leave A Reply
      </h2>
      <section className="max-w-6xl mx-auto p-12 bg-white rounded-2xl ">
        {/* Name & Email Fields */}
        <div className="flex flex-col gap-5 ">
          <p className="text-[#717171] font-poppins mb-6 text-[22px] leading-8">
            Your Email Address Will Not Be Published.
          </p>

          {/* Comment Field */}
          <div className="flex flex-col gap-4">
            <label className="text-[#717171] font-poppins font-[500]  text-[26px] leading-8 mb-2">
              Comment
            </label>
            <textarea
