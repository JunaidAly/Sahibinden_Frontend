...
//   // Handle adding ad to selected list - FIXED VERSION
...
//     // Fixed null check - check if we have either currentAd with ID or currentAdId
//     const adId = currentAd?.addID || currentAd?.id || currentAdId;
//     if (!adId) {
//       alert('Ad ID is missing. Please try again.');
//       return;
//     }
...
//       // Get category from addID - use the adId we determined above
//       const category = await getCategoryFromAddId(adId);

//       // Create the ad object for favoriteItem collection (existing functionality)
//       const newAdData = {
//         addID: adId,
//         addowner: currentAd?.addowner || currentAd?.ownerId || getAddOwnerFromId(adId),
//         category: category,
...
//         addID: adId,
//         addowner: getAddOwnerFromId(adId),
//         category: category,
