...
//       if (!contactInfo?.receiverId && !contactInfo?.adOwnerId) {
//         throw new Error('Missing ad owner ID');
//       }
...
//   // Enhanced message sending with updated structure
...
//       // Update the message document to include its own ID field
