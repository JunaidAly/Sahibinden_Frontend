...
function MyDeliveryAddressForm() {
      ...
      <div className="space-y-4 shadow-custom-right p-6 rounded-md bg-white">
        ...
        <div>
          ...
          <div className="relative">
            ...
            <FaCaretDown
              className="absolute right-3 top-1/2 transform -translate-y-1/2 text-[#1544AB] pointer-events-none"
              size={20}
            />
          </div>
        </div>
...
export default MyDeliveryAddressForm;
