...
function ReturnsAndCancellations() {
  ...
  return (
    <div className="max-w-5xl w-full mx-auto p-4 font-poppins">
      <div className="bg-white rounded-lg ">
        <h1 className="text-xl font-semibold ">Returns and Cancellations</h1>
        ...
        <div className="py-4">
          <div className="flex flex-col gap-4 mb-6">
            <input
              type="text"
              placeholder=" among the returned items, the advertisement number is."
          ...
          <div className="relative flex justify-between items-center border border-[#1544AB] rounded-lg p-2">
            <h1>You do not have a returned product.</h1>
            <button
