...
function ApprovalFromTheBuyer() {
  ...
  return (
    <div className="max-w-5xl w-full mx-auto p-4 font-poppins">
      <div className="bg-white rounded-lg ">
        ...
        <div className="py-4">
          <div className="flex flex-col gap-4 mb-6">
            <input
              type="text"
              placeholder="among the ones i expect approval from the buyer, the advertisement number is."
          ...
          <div className="relative flex justify-between items-center border border-[#1544AB] rounded-lg p-2">
            <h1>
              You do not have any products awaiting approval from the buyer.
            </h1>
            <button
        ...
        {/* Table Section */}
        <div className="overflow-x-auto max-w-5xl w-full mx-auto bg-[#CFCFCF80] ">
          <table
...
export default ApprovalFromTheBuyer;
