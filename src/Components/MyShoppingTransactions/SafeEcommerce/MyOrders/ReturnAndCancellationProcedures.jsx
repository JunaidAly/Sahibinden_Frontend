...
function ReturnAndCancellationProcedures() {
      ...
      <div className="bg-white rounded-lg ">
        ...
        <div className="py-4">
          <div className="flex flex-col gap-4 mb-6">
            <input
              type="text"
              placeholder="In my recent transactions, with the advertisement number"
          ...
          <div className="relative flex justify-between items-center border border-[#1544AB] rounded-lg p-2">
            <h1> There is no refund process.</h1>
            <button
...
export default ReturnAndCancellationProcedures;
