        ...
        <div className="max-w-7xl w-full h-full mx-auto  mt-12">
          <div className="w-full h-full flex flex-row justify-center items-center  gap-5 ">
            <div className="p-5 bg-white shadow-custom-diagonal rounded-lg">
                ...
                <h1 className="font-medium text-xl ">What are Diesel Engines?</h1>
              <img
                src="/assets/image40.png"
                alt="Real estate image"
                className="w-full h-full object-cover"
              />
              <a className="text-primaryBlue text-sm text-right  font-medium" >More</a>
              </div>
            </div>
            ...
            <div className="p-5 bg-white shadow-custom-diagonal rounded-lg">
              ...
              <img
                ...
                className="w-full h-full object-cover"
              />
              <a className="text-primaryBlue text-sm font-medium text-right " >More</a>
              </div>
            </div>
          </div>
        </div>
