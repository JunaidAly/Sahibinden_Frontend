  ...
  const vehicleInfoItems = [
    {
      ...
      description: "The document showing that the debtor does not have sufficient assets fo the legallypursued payment is called the insolvency certificate. This document is issued by theenforcement office. From the creditor’s perspective, it is the document issued by theenforcement office for the unpaid part of the receivable as a result of the enforcement Proceedings. The content of the insolvency certificate includes;",
      image: "/assets/purchase.png",
      letter: "A"
    },
    {
      id: 2,
      title: "What is Open Tender Procedure?",
      description: "The open tender method is the tender method that is open to participants and anyonewho wants to can submit an offer. In this case, the tender is announced to the public and each candidate is expected to prepare an offer letter. The offer letter represents the budget determined by the candidate for the job. In the open tender method, candidates simply.....",
      image: "/assets/purchase.png",
      letter: "C"
    }
  ];
  ...
  return (
    ...
    <div className="max-w-7xl mx-auto  p-4 rounded-lg font-sans">
        ...
        <div className="flex justify-between items-center mb-10 font-poppins">
          <h1 className="text-[35px] font-[600] text-black">Real Estate Dictionary</h1>
          {/* Search Bar */}
