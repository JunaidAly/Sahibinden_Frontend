      ...
      <div className="max-w-7xl mx-auto font-poppins p-6">
        ...
        <div className="bg-white   mb-8">
          ...
          <p className="text-[20px] font-[500] text-black">
            ...
            apartment management plan. In addition, issues such as manager
            selection, meeting times, shared responsibilities or prohibitions
            are also determined by the management plan. <br />
            People who want to buy real estate have the right to request and
            examine the management plan from the General Directorate of Land
            Registry and Cadastre. The possibility of encountering an unexpected
            situation can be eliminated by reading the management plan before
        ...
        <div className="bg-white ">
          ...
          <ul className="space-y-2 mb-6">
            {managementPlains.map((item, index) => (
...
export default AfterLeaseOverview