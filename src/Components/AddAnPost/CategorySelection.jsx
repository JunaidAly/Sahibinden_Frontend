...
//   return (
//     <div className="max-w-[1300px] mx-auto p-6 h-[644px] mt-10 font-poppins bg-white rounded-lg shadow-custom">
    ...
    <div className="max-w-[1300px] mx-auto p-6 h-[644px] mt-10 font-poppins bg-white rounded-lg shadow-custom">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
        {categories.map((category) => (
          <Link 
            key={category.id}
            to={`/category-selection-details/${category.slug}`}
            className="bg-white p-6 w-[246px] h-[236px] rounded-lg shadow-custom cursor-pointer flex flex-col items-center justify-center text-center hover:shadow-lg transition-shadow"
          >
            <div className="mb-4">
              <img 
                src={category.icon} 
